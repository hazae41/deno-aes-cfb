...
export class Aes128Cfb8 {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Aes128Cfb8.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_aes128cfb8_free(ptr);
    }
    /**
    * @param {Uint8Array} secret
    * @param {Uint8Array} iv
    */
    constructor(secret, iv) {
        ...
        var ptr1 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        var ret = wasm.aes128cfb8_new(ptr0, len0, ptr1, len1);
        return Aes128Cfb8.__wrap(ret);
    }
    /**
    * @param {Uint8Array} data
    */
    encrypt(data) {
        try {
            var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.aes128cfb8_encrypt(this.ptr, ptr0, len0);
        } finally {
            data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
            wasm.__wbindgen_free(ptr0, len0 * 1);
        }
    ...
    */
    decrypt(data) {
        try {
            var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.aes128cfb8_decrypt(this.ptr, ptr0, len0);
        } finally {
            data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
            wasm.__wbindgen_free(ptr0, len0 * 1);
        }
...
export class Aes192Cfb8 {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Aes192Cfb8.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_aes192cfb8_free(ptr);
    }
    /**
    * @param {Uint8Array} secret
    * @param {Uint8Array} iv
    */
    constructor(secret, iv) {
        ...
        var ptr1 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        var ret = wasm.aes192cfb8_new(ptr0, len0, ptr1, len1);
        return Aes192Cfb8.__wrap(ret);
    }
    /**
    * @param {Uint8Array} data
    */
    encrypt(data) {
        try {
            var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.aes192cfb8_encrypt(this.ptr, ptr0, len0);
        } finally {
            data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
            wasm.__wbindgen_free(ptr0, len0 * 1);
        }
    ...
    */
    decrypt(data) {
        try {
            var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.aes192cfb8_decrypt(this.ptr, ptr0, len0);
        } finally {
            data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
            wasm.__wbindgen_free(ptr0, len0 * 1);
        }
...
export class Aes256Cfb8 {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Aes256Cfb8.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_aes256cfb8_free(ptr);
    }
    /**
    * @param {Uint8Array} secret
    * @param {Uint8Array} iv
    */
    constructor(secret, iv) {
        ...
        var ptr1 = passArray8ToWasm0(iv, wasm.__wbindgen_malloc);
        var len1 = WASM_VECTOR_LEN;
        var ret = wasm.aes256cfb8_new(ptr0, len0, ptr1, len1);
        return Aes256Cfb8.__wrap(ret);
    }
    /**
    * @param {Uint8Array} data
    */
    encrypt(data) {
        try {
            var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.aes256cfb8_encrypt(this.ptr, ptr0, len0);
        } finally {
            data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
            wasm.__wbindgen_free(ptr0, len0 * 1);
        }
    ...
    */
    decrypt(data) {
        try {
            var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
            var len0 = WASM_VECTOR_LEN;
            wasm.aes256cfb8_decrypt(this.ptr, ptr0, len0);
        } finally {
            data.set(getUint8Memory0().subarray(ptr0 / 1, ptr0 / 1 + len0));
            wasm.__wbindgen_free(ptr0, len0 * 1);
        }
